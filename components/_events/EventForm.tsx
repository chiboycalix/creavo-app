...
export interface EventFormData {
  ...
  isPaid: boolean
  type: string
  includeWebinar: boolean
  internalParticipant?: { email: string }[]
...
const EventForm: React.FC<EventFormProps> = ({ eventToEdit, onSubmit, submitButtonText = "SAVE", className = "" }) => {
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
          <Checkbox id="webinar" checked={isWebinar} onCheckedChange={(checked) => setIsWebinar(checked === true)} />
        ...
        <div className="flex items-center space-x-2">
          <Checkbox id="allDay" checked={isAllDay} onCheckedChange={(checked) => setIsAllDay(checked === true)} />
          <Label htmlFor="allDay">All Day</Label>
        </div>
        <div className="flex items-center space-x-2">
          <Checkbox id="repeat" checked={isRepeating} onCheckedChange={(checked) => setIsRepeating(checked === true)} />
