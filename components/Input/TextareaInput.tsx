  ...
  return (
    <div className="leading-3">
      ...
      <div className="relative">
        ...
        <textarea
          className={cn(
            "outline-none focus:ring-0 border-primary-100 border-2 rounded-lg py-3 text-gray-800 text-sm w-full disabled:cursor-not-allowed placeholder:text-gray-400 placeholder:normal-case",
