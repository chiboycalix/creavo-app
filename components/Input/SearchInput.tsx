  ...
  return (
    <div className="leading-3 w-full">
      ...
      <div className="relative">
        ...
        <input
          className={cn(
            "outline-none focus:ring-0 ring-primary-700 border-primary-100 border-2 rounded-md py-3 text-gray-800 text-sm text-wrap w-full disabled:cursor-not-allowed placeholder:text-gray-400 placeholder:normal-case",
            leftIcon ? "pl-10" : "pl-3",
            rightIcon ? "pr-10" : "pr-3",
            errorMessage ? "bg-red-100" : "bg-primary-50/25",
            "bg-primary-50/25rounded-md",
            className
          )}
          {...rest}
        />
