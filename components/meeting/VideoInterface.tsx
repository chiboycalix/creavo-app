  ...
  return (
    <div>
      {hasJoinedMeeting ? (
        ...
        <>
          {
            isLoading ? <div className='w-full h-full fixed inset-0 flex items-center justify-center z-[150] bg-[#1A1C1D]'>
            ...
            </div> : <div className="w-full max-w-md mx-auto px-0 sm:px-6 pt-2">
